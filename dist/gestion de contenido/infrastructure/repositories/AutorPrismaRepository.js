...
class AutorPrismaRepository {
    crear(autor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Autor_1.Autor(creado.id, new NombreAutor_1.NombreAutor(creado.nombre), creado.biografia || '');
        });
    }
    buscarPorId(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!autor)
                return null;
            return new Autor_1.Autor(autor.id, new NombreAutor_1.NombreAutor(autor.nombre), autor.biografia || '');
        });
    }
    listar() {
        return __awaiter(this, void 0, void 0, function* () {
            const autores = yield client_1.default.autor.findMany();
            return autores.map(a => new Autor_1.Autor(a.id, new NombreAutor_1.NombreAutor(a.nombre), a.biografia || ''));
        });
    }
}
