...
class GeneroPrismaRepository {
    crear(genero) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Genero_1.Genero(creado.id, creado.nombre);
        });
    }
    buscarPorNombre(nombre) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!encontrado)
                return null;
            return new Genero_1.Genero(encontrado.id, encontrado.nombre);
        });
    }
    listar() {
        return __awaiter(this, void 0, void 0, function* () {
            const generos = yield client_1.default.genero.findMany();
            return generos.map(g => new Genero_1.Genero(g.id, g.nombre));
        });
    }
}
